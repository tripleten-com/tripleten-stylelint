...
export default async function main(argv) {
	...
	if (isString(customFormatter)) {
		...
		formatter = /** @type {import('tripleten-stylelint').FormatterType} */ (formatterInput);
	}

	/** @type {import('tripleten-stylelint').LinterOptions} */
	const options = {
		formatter,
	};
 ...
 * @returns {Promise<import('tripleten-stylelint').Formatter>}
 */
