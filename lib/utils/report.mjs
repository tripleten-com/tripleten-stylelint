 ...
 *
 * @type {import('tripleten-stylelint').Utils['report']}
 */
export default function report(problem) {
	...
	/** @type {import('tripleten-stylelint').WarningOptions} */
...
/**
 * @param {import('tripleten-stylelint').RuleMessage} message
 * @param {import('tripleten-stylelint').Problem['messageArgs']} messageArgs
 * @returns {string}
 */
