...
/** @typedef {import('tripleten-stylelint').RuleOptions} RuleOptions */
/** @typedef {import('tripleten-stylelint').RuleOptionsPossible} RuleOptionsPossible */

/**
 * @type {import('tripleten-stylelint').Utils['validateOptions']}
 */
