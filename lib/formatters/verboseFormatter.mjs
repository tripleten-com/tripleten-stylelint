...
/** @typedef {import('tripleten-stylelint').LintResult} LintResult */
/** @typedef {import('tripleten-stylelint').Warning} Warning */
/** @typedef {import('tripleten-stylelint').Severity} Severity */
/** @typedef {import('tripleten-stylelint').RuleMeta} RuleMeta */
