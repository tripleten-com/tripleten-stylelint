...
/** @typedef {import('tripleten-stylelint').DisabledRange} DisabledRange */
/** @typedef {import('tripleten-stylelint').DisableReportRange} DisableReportRange */

/**
 * @param {import('tripleten-stylelint').LintResult[]} results
 */
...
/**
 * @param {import('tripleten-stylelint').DisabledWarning} warning
