/** @typedef {import('tripleten-stylelint').DisableReportRange} DisabledRange */
/** @typedef {import('tripleten-stylelint').LintResult} StylelintResult */
/** @typedef {import('tripleten-stylelint').ConfigRuleSettings<any, Object>} StylelintConfigRuleSettings */
